...
System Engineer (ECU Cooling) at Volvo Group, based in Bengaluru, India. I design and validate thermal systems and cooling strategies for vehicle control units (ECUs) and power electronics, working at the intersection of systems engineering, simulation, and experimental validation.
...
- Domain: Thermal & energy systems; EV powertrain (cells, battery packs, MCU, BMS); ECU thermal budgets
- Systems engineering: Requirements, DFMEA/SFMEA, SystemWeaver, risk registers, supplier integration
- Simulation & modelling: GT‑Suite, Simulink, STAR‑CCM+, Abaqus, FE modelling, ROMs
- Testing & validation: Thermal runaway tests, CT scanning, CAN analysis, energy mapping
- Data & programming: Python, MATLAB, C/C++, Git, PowerBI, telematics & fleet analytics
- CAD & design: NX, SolidWorks, Fusion 360, Creo
